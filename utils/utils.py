...
def plot_eff(data, weights, name, num_bins, x_min, x_max, eta=False, bkg=False):
    ...
    pt_1p3p_dnom = plt_to_root_hist_w(data[0], num_bins, x_min, x_max, None, eta)
    pt_1p3p_num =  plt_to_root_hist_w(data[1], num_bins, x_min, x_max, None, eta)
    pt_1p1p_dnom = plt_to_root_hist_w(data[2], num_bins, x_min, x_max, None, eta)
    pt_1p1p_num =  plt_to_root_hist_w(data[3], num_bins, x_min, x_max, None, eta)
    pt_3p3p_dnom = plt_to_root_hist_w(data[4], num_bins, x_min, x_max, None, eta)
    pt_3p3p_num =  plt_to_root_hist_w(data[5], num_bins, x_min, x_max, None, eta)
    pt_inc_dnom =  plt_to_root_hist_w(data[6], num_bins, x_min, x_max, None, eta)
    pt_inc_num =   plt_to_root_hist_w(data[7], num_bins, x_min, x_max, None, eta)
    ...
    ###for omni
    if bkg:
        # pt_1p3p_eff.GetYaxis().SetRangeUser(0, 300)
        # pt_1p1p_eff.GetYaxis().SetRangeUser(0, 300)
        # pt_3p3p_eff.GetYaxis().SetRangeUser(0, 300)
        # pt_inc_eff.GetYaxis().SetRangeUser(0, 300)
        pt_1p3p_eff.GetYaxis().SetRangeUser(0, 3)
        pt_1p1p_eff.GetYaxis().SetRangeUser(0, 3)
        pt_3p3p_eff.GetYaxis().SetRangeUser(0, 3)
        pt_inc_eff.GetYaxis().SetRangeUser(0, 3)
    else:
        # pt_1p3p_eff.GetYaxis().SetRangeUser(0.5, 1.3)
        # pt_1p1p_eff.GetYaxis().SetRangeUser(0.5, 1.3)
        # pt_3p3p_eff.GetYaxis().SetRangeUser(0.5, 1.3)
        # pt_inc_eff.GetYaxis().SetRangeUser(0.5, 1.3)
        pt_1p3p_eff.GetYaxis().SetRangeUser(0, 1.4)
        pt_1p1p_eff.GetYaxis().SetRangeUser(0, 1.4)
        pt_3p3p_eff.GetYaxis().SetRangeUser(0, 1.4)
        pt_inc_eff.GetYaxis().SetRangeUser(0, 1.4)
    
    # if bkg:
    #     pt_1p3p_eff.GetYaxis().SetRangeUser(0, 1000)
    #     pt_1p1p_eff.GetYaxis().SetRangeUser(0, 1000)
    #     pt_3p3p_eff.GetYaxis().SetRangeUser(0, 1000)
    #     pt_inc_eff.GetYaxis().SetRangeUser(0, 1000)
    # else:
    ...
    if bkg:
        pt_1p3p_eff.GetYaxis().SetTitle('Background Rejection')
